...
declare const SymphocityEuBackendApplication_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
...
export declare class SymphocityEuBackendApplication extends SymphocityEuBackendApplication_base {
